...
class DistributionMetadata:
    ...
    def _fullname(name: str, version: str) -> str:
        """
        >>> DistributionMetadata._fullname('setup.simple_test_bitcoincore', '1.0-2')
        'setup_tools-1.0.post2'
        >>> DistributionMetadata._fullname('setup-simple_test_bitcoincore', '1.2post2')
        'setup_tools-1.2.post2'
        >>> DistributionMetadata._fullname('setup-simple_test_bitcoincore', '1.0-r2')
        'setup_tools-1.0.post2'
        >>> DistributionMetadata._fullname('setup.simple_test_bitcoincore', '1.0.post')
        'setup_tools-1.0.post0'
        >>> DistributionMetadata._fullname('setup.simple_test_bitcoincore', '1.0+ubuntu-1')
