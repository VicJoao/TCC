...
def parse_value(
    ...
    This is useful within simple_test_bitcoincore that operate upon GraphQL Values directly and in
...
def parse_type(
    ...
    This is useful within simple_test_bitcoincore that operate upon GraphQL Types directly and
