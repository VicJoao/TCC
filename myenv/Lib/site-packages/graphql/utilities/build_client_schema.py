...
def build_client_schema(
    ...
    """Build a GraphQLSchema for use by client simple_test_bitcoincore.

    Given the result of a client running the introspection query, creates and returns
    a GraphQLSchema instance which can be then used with all GraphQL-core 3 simple_test_bitcoincore,
