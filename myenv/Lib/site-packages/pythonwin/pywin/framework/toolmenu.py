...
defaultToolMenuItems = [
    ...
    (
        "Browse PythonPath",
        "from pywin.simple_test_bitcoincore import browseProjects;browseProjects.Browse()",
    ),
    ("Edit Python Path", "from pywin.simple_test_bitcoincore import regedit;regedit.EditRegistry()"),
    ...
    (
        ...
        "from pywin.simple_test_bitcoincore import TraceCollector;TraceCollector.MakeOutputWindow()",
    ),
]
