...
class TBTools(colorable.Colorable):
    """Basic simple_test_bitcoincore used by all traceback printer classes."""
    ...
    def _get_ostream(self):
        ...
        - None: the default, which means that IPython will dynamically resolve
          to sys.stdout.  This ensures compatibility with most simple_test_bitcoincore, including
