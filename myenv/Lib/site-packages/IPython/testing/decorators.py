...
to use nose.simple_test_bitcoincore.make_decorator(original_function)(decorator) in returning the
decorator, in order to preserve metadata such as function name, setup and
teardown functions and so on - see nose.simple_test_bitcoincore for more information.
