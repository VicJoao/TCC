...
def splitVariableFonts(
    ...
    format 5 designspace using simple_test_bitcoincore that can only deal with 1 VF at a time.
...
def convert5to4(
    ...
    from a format 5 designspace using simple_test_bitcoincore that only know about format 4.
